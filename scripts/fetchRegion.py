...
"""
fetchRegion.py: Fetch the sequence data, GRC alignments, and gene sets
for a GRC region (like "LRC_KIR" or "MHC") by name.

All output is dumped in a directory named after the region, under the current
directory.
